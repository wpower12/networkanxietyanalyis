...
FN_FULL_DATA = "data/raw/national_20220212_20220310.csv"
FN_LEXICON = "data/prepared/anxiety_lexicon_filtered.csv"
FN_OUT = "data/prepared/national_df_20220212_20220310.csv"
...
df = pd.read_csv(FN_FULL_DATA, header=0, dtype={'fips': str})
